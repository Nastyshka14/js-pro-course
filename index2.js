...
// let promiseUsers1 = fetch(`https://jsonplaceholder.typicode.com/albums/1/photos`)
// .then((res) => res.json())
// .then((result) => console.log('users promise', result))
...
// console.log('users async await', result)
// } catch error {
//   console.log(error)}
// getUsers().then
...
// async function getUsersCardList() {
